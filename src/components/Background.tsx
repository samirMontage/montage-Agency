...
export function Background() {
  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden" aria-hidden>
      ...
      {/* Цветные блобы */}
      <div className="absolute -left-[18%] top-[-12%] h-[46rem] w-[46rem] animate-blob rounded-full bg-[radial-gradient(circle,rgba(0,212,255,0.16),transparent_65%)] blur-3xl" />
      <div className="absolute -right-[14%] top-[26%] h-[40rem] w-[40rem] animate-blob-slow rounded-full bg-[radial-gradient(circle,rgba(0,110,255,0.13),transparent_65%)] blur-3xl" />
      <div className="absolute bottom-[-16%] left-[24%] h-[38rem] w-[38rem] animate-blob rounded-full bg-[radial-gradient(circle,rgba(0,255,200,0.09),transparent_65%)] blur-3xl [animation-delay:-8s]" />

      {/* Кольцо-орбита */}
      <div className="absolute left-1/2 top-1/2 h-[52rem] w-[52rem] -translate-x-1/2 -translate-y-1/2 animate-spin-slow rounded-full border border-white/[0.04] [mask-image:radial-gradient(circle,black,transparent_72%)]" />
